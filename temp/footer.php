            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="https://bit.ly/2GYbn9p" class="title">Phone / WA</a>
                            <p class="sub-title">+62878 2323 7339</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="mailto:official@asiadigitalindonesia.com" class="title">Email support</a>
                            <p class="sub-title">official@asiadigitalindonesia.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">Alamat</a>
                            <p class="sub-title">Ruko Pasar Modern Batununggal Blok RD.27</p>
                        </div>
                    </div>
                </div>
            </div>
...
a
<script src="static/js/crum-mega-menu.js"></script>
...
<script src="static/js/animation.velocity.min.js"></script>
